...
class RequestBuilder(object):
    def __init__(self, path: str, **kwargs):
        ...
        :param path: The base path of the request. Should be without a trailing slash
        :param kwargs: Additional keywork arguments to give to the request.
                       Should only be arguments that are supported by the requests library
        """
        self._path: str = path
